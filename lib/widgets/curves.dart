...
class Curves with _$Curves {
  ...
  static const fastLinearToSlowEaseIn = Cubic(0.18, 1.0, 0.04, 1.0);
  static const fastEaseInToLinear = Cubic(0.25, 0.1, 0.25, 1.0);
  static const ease = Cubic(0.25, 0.1, 0.25, 1.0);
  ...
  static const slowMiddle = Cubic(0.4, 0.0, 0.6, 1.0);
